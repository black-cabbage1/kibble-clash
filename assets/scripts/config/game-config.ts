...
export const DEFAULT_GAME_CONFIG: GameConfig = {
  ...
  ai: {
    ...
    difficultyConfigs: {
      ...
      hard: { rewardWeight: 0.52, winningChanceWeight: 64, tieRiskWeight: 62, competitionRiskWeight: 26, diceEfficiencyWeight: 26, scoreSituationWeight: 24, roundSituationWeight: 22, optimalChoiceProbability: 0.88, temperature: 0.25, candidateLimit: 2 },
    },
  },
